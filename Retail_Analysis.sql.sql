...
---Q1.	What is the total number of rows in each of the 3 tables in the database?
          SELECT count(*) as tot_rows FROM Customer
          SELECT count(*) as tot_rows FROM prod_cat_info
          SELECT count(*) as tot_rows FROM Transactions

/*Q2. What is the total number of transactions that have a return? */
          SELECT COUNT(*) AS RETURN_TRANS 
          FROM Transactions
          WHERE QTY<0
...
/* Q4.	What is the time range of the transaction data available for analysis? 
 ...
 /*Q5.Which product category does the sub-category “DIY” belong to?  */
   ...
   /* Q1. WHICH CHANNEL IS USED FREUQUENTY FOR TRANSACTIONS*/
         ...
         SELECT TOP 1 COUNT(STORE_TYPE) as frequency, Store_type
         FROM Transactions
         GROUP  BY store_type
   ...
   /* Q3.From which city do we have the maximum number of customers and how many?*/
        ...
        select top 1 city_code , count(customer_id) as No_of_customer
        from Customer
        group by city_code 
   ...
   /* Q6.What is the net total revenue generated in categories Electronics and Books?*/
    ...
    /* Q8.What is the combined revenue earned from the “Electronics” & “Clothing” categories, from “Flagship stores”?*/
     ...
     /* Q9.What is the total revenue generated from “Male” customers in “Electronics” category? 
          ...
          on x.prod_cat_code=y.prod_cat_code and x.prod_subcat_code=y.prod_sub_cat_code
          inner join Customer as z
          on x.cust_id=z.customer_Id
   ...
   /*Q13.Which store-type sells the maximum products; by value of sales amount and by quantity sold?*/
           ...
           select TOP 1 store_type, sum(total_amt) as tot_amt , sum(qty) as tot_qty
           from Transactions
           group by Store_type
